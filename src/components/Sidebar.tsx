...
const Sidebar = () => {
  ...
  return (
    <>
      {/* Desktop View */}
      <div className="box-content hidden min-h-screen min-w-[250px] flex-col bg-indigo-300 py-10 pl-2 md:flex md:w-1/5 lg:pl-4">
        <p className="text-xl font-bold text-indigo-800">
          Contact Management Application
        </p>
        <ul className="flex flex-col gap-5 py-10 font-semibold text-slate-50">
          <Link to="/">
      ...
      {/* MOBILE VIEW */}
      <div className="absolute top-0 z-10 w-full bg-indigo-300 px-8 py-4 shadow-lg md:hidden">
        {/* Hamburger icon */}
